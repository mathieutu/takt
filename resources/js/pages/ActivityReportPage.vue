...
const editingTitle = computed(() => {
    ...
    const month = MONTHS_FR[parseInt(editingReport.value.start_date.slice(5, 7)) - 1]
    return `${day} ${month}`
})
                ...
                <div class="mt-auto shrink-0">
                    <div class="pt-3 hidden items-center gap-5 sm:flex">
                        <div class="flex items-center gap-1.5">
                            <span class="h-3 w-3 rounded-sm border border-default bg-primary/25"></span>
                            <span class="text-xs text-muted">1 jour</span>
                        </div>
                        <div class="flex items-center gap-1.5">
                            <span class="h-3 w-3 rounded-sm border border-default bg-primary/10"></span>
